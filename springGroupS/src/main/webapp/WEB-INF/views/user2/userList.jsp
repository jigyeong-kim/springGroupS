...
<head>
  ...
  <script>
  	...
  	//조건 : 아이디 검색시 검색한 아이디가 없으면 본문 리스트에는 '검색하신 'mid'가 없습니다.' 출력
...
<div class="container">
  <h2>User 리스트</h2>
  <div class="mb-3">
  	<a href="userInput" class="btn btn-success btn-sm">User 등록</a>
  </div>
  <table class="table table-hover text-center">
    ...
    <c:if test="${fn:length(vos) == 0}">
	    <tr>
	    	<td colspan="6" class="text-center">검색하신 ${mid}가 없습니다</td>
	    </tr>
    </c:if>
  </table>
  <hr>
