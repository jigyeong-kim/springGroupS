...
select * from review v, reviewReply r where part='pds' and v.partIdx=6 and v.idx=r.reviewIdx;

select * from review v inner join reviewReply r on part='pds' and v.partIdx=6 and v.idx=r.reviewIdx;

select * from review v left join reviewReply r on part='pds' and v.partIdx=6 and v.idx=r.reviewIdx;
