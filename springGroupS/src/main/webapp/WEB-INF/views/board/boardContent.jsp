...
<div class="container">
  ...
  <table class="table table-borderless m-0 p-0">
    <tr>
      <td class="text-start">
        <c:if test="${pageVO.boardFlag == 'search'}"><input type="button" value="돌아가기" onclick="location.href='boardSearchList?search=${search}&searchString=${searchString}';" class="btn btn-success" /></c:if>
        <c:if test="${pageVO.boardFlag != 'search'}"><input type="button" value="돌아가기" onclick="location.href='boardList?pag=${pag}&pageSize=${pageSize}';" class="btn btn-success" /></c:if>
      </td>
      <td class="text-end">
