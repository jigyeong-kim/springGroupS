...
<div class="container">
  ...
  <form name="myform" method="post">
    ...
    <table class="table table-bordered">
      ...
      <tr>
	      <th>이메일</th>
	      <td><input type="text" name="buyer_email" value="fam123123@naver.com" class="form-control"/></td>
      </tr>
      <tr>
	      <th>주문자</th>
	      <td><input type="text" name="buyer_name" value="김지경" class="form-control"/></td>
      </tr>
      <tr>
	      <th>연락처</th>
	      <td><input type="text" name="buyer_tel" value="010-2780-3998" class="form-control"/></td>
      </tr>
      <tr>
	      <th>우편번호</th>
