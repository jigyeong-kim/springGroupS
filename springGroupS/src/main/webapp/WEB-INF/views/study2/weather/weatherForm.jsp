...
<head>
  ...
  <script>
	  ...
	  // 서울지역의 날씨를 ajax를 이용하여 출력하기
		$.ajax({
			url  : 'https://api.openweathermap.org/data/2.5/weather?q=Seoul,kr&appid=bf8a0910f0d6da740bff43a731abee3f&units=metric',
			type : 'post',
    ...
    $.getJSON('https://api.openweathermap.org/data/2.5/weather?q=Seoul,kr&appid=bf8a0910f0d6da740bff43a731abee3f&units=metric',
   		function (res) {
