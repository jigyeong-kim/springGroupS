	...
	<div class="container">
		...
		<script>
			var mapContainer = document.getElementById('map'), // 지도를 표시할 div 
			    mapOption = { 
			        center: new kakao.maps.LatLng(36.634869436960415, 127.46018227062184), // 지도의 중심좌표
			        level: 3 // 지도의 확대 레벨
			    };
			...
			kakao.maps.event.addListener(map, 'click', function(mouseEvent) {        
			    ...
			    message += '<input type="button" value="장소DB저장" onclick="addressSave(' + latlng.getLat() + ', ' + latlng.getLng() + ')" class="btn btn-success btn-small"></p>';
