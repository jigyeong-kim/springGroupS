...
<jsp:include page="/WEB-INF/views/include/slide2.jsp" />
	<div class="container">
		<h2>암호화 연습</h2>
		<pre>
			<font size="5">SHA-256</font>
			SHA256 암호화 방식은 SHA(Secure Hash Algorithm) 알고리즘의 한종류로, 256비트로 구성되며 64자리 문자열로 구성된다.
			SHA256은 단방향 암호화 방식으로 복호화가 불가능하고, 속도가 빠르다는 장점이 있다. 관리자가 재정희해서 사용할수 있다.
			<hr>
			<font size="5">ARIA</font>
			...
			<hr>
			<font size="5">BCryptPasswordEncoder</font>
		...
		<div class="input-group mb-3">
			<input type="text" name="pwd" id="pwd" value="qwer1234!!" autofocus="autofocus" required="required">
