      ...
      <tr>
        ...
        <td>
          <div class="input-group">
            ...
            <input type="button" value="주소록" onclick="jusorokCheck()" class="btn btn-success" data-bs-toggle="modal" data-bs-target="#myModal2"/>
          </div>
        </td>
      </tr>
      <tr>
	  ...
	  <div class="modal-dialog">
	    <div class="modal-content">
	      ...
	      <div class="modal-body">
	      	<c:if test="${empty jusoList}">
	          <p class="text-center text-muted">등록된 주소가 없습니다.</p>
	        </c:if>
	      	 <c:forEach var="vo" items="${vos}">
	          <div class="input-group mb-2">
	            <div class="input-group-text">
	              <input type="checkbox" name="juso" value="${vo.email}" class="form-check-input mt-0"/>
	            </div>
