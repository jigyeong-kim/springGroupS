...
<jsp:include page="/WEB-INF/views/include/slide2.jsp" />
	<div class="container">
		<h2>Mapping 연습</h2>
		<hr style="border-width:10px; border-color:#000">
		<p><b>Query String방식(?변수=값)</b></p>
		<hr style="border-width:10px; border-color:#ccc">
		
		<p>
			<a href="${ctp}/study1/mapping/test01?mid=hkd1234&pwd=1234" class="btn btn-success">test01</a>
			<a href="test02?mid=kms1234&pwd=5678" class="btn btn-primary">test02</a>
			<a href="test03?mid=lkj1234&pwd=4321" class="btn btn-secondary">test03</a>
			<a href="test04?mid=snm1234&pwd=8765&sex=2" class="btn btn-info">test04</a>
			<a href="test05?mid=snm1234&pwd=8765&name=소나무&gender=남자&age=20" class="btn btn-dark">test05</a>
		</p>
		<p>
			<a href="test06?mid=oh1234&pwd=1357&name=오하늘&gender=여자&age=22" class="btn btn-outline-success">test06</a>
			<a href="test07?mid=gid1234&pwd=2468&name=고인돌&gender=남자&age=66" class="btn btn-outline-primary">test07</a>
			<a href="test08?mid=atom1234&pwd=0987&name=아톰&gender=중성&age=12" class="btn btn-outline-secondary">test08</a>
			<a href="test09?mid=btom1234&pwd=5678&name=비톰&gender=남자&age=44" class="btn btn-outline-info">test09</a>
		</p>
		...
		<p>
			...
			<a href="1111/test23/lkj1234" class="btn btn-secondary">test23</a>
			<a href="3333/___/test24/oh1234" class="btn btn-info">test24</a>
			<a href="test25/btom1234/5678/비톰/___/남자/44" class="btn btn-dark">test25</a>
		</p>
